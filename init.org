...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-<left>") 'centaur-tabs-vertical-forward-tab)
  (global-set-key (kbd "C-<right>") 'centaur-tabs-vertical-backward-tab)
...
#+begin_src emacs-lisp
  (use-package centaur-tabs-vertical
    :ensure t
    :demand t
    :bind (("C-c j" . centaur-tabs-vertical-jump-to-agent))
    :config
    (setq centaur-tabs-vertical-new-tab-action
          (lambda ()
            (if (fboundp 'dashboard-open)
                (dashboard-open)
              (switch-to-buffer "*dashboard*"))))
    (dolist (face '(centaur-tabs-vertical-tab-selected-face
                    centaur-tabs-vertical-tab-unselected-face))
