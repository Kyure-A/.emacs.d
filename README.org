  ...
  (eval-when-compile
    (unless (file-directory-p "~/.emacs.d/elpa/el-clone")
      (if (fboundp 'package-vc-install)
          (progn (package-vc-install "https://github.com/Kyure-A/el-clone.git")
                 (package-vc-install "https://github.com/emacscollective/borg.git"))
...
#+begin_src emacs-lisp
  (eval-when-compile
    (unless (file-directory-p "~/.emacs.d/elpa/borg")
      (if (fboundp 'package-vc-install)
          (package-vc-install "https://github.com/emacscollective/borg.git")
        (customize-set-variable 'package-archives '(("kelpa" . "https://kelpa.kyre.moe/")))
        (package-initialize)
  ...
  (eval-and-compile
    (add-to-list 'load-path "~/.emacs.d/elpa/borg")
    (require 'borg)
    (require 'borg-elpa)
